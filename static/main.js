...
define(['base/js/namespace', 'jquery', 'components/es6-promise/promise.min', 'thebe/dotimeout', 'notebook/js/notebook', 'thebe/default_css', 'contents', 'services/config', 'base/js/utils', 'base/js/page', 'base/js/events', 'notebook/js/actions', 'notebook/js/kernelselector', 'services/kernels/kernel', 'codemirror/lib/codemirror', 'components/term.js/src/term', 'codemirror/mode/ruby/ruby', 'codemirror/mode/css/css', 'codemirror/mode/coffeescript/coffeescript', 'codemirror/mode/dockerfile/dockerfile', 'codemirror/mode/go/go', 'codemirror/mode/javascript/javascript', 'codemirror/mode/julia/julia', 'codemirror/mode/python/python', 'codemirror/mode/haskell/haskell', 'codemirror/mode/r/r', 'codemirror/mode/shell/shell', 'codemirror/mode/clike/clike', 'codemirror/mode/jinja2/jinja2', 'codemirror/mode/php/php', 'codemirror/mode/sql/sql', 'nbextensions/widgets/notebook/js/extension', 'custom/custom'], function(IPython, $, promise, doTimeout, notebook, default_css, contents, configmod, utils, page, events, actions, kernelselector, kernel, CodeMirror, custom) {
  var Thebe;
  Thebe = (function() {
    ...
    Thebe.prototype.setup_constants = function() {
      ...
      if (this.options.error_addendum === false) {
        ...
        return this.ui['error_addendum'] = "<button class='btn btn-toolbar btn-danger btn-embossed' data-action='run-above'>Run All Above</button><p class='small'>It looks like there was an error.</p>";
      } else {
    ...
    Thebe.prototype.build_thebe = function() {
      ...
      $(this.selector).add(this.options.not_executable_selector).each((function(_this) {
        return function(i, el) {
          ...
          controls = $("<div class='thebe_controls' data-cell-id='" + i + "' style='padding-top: 10px; margin-left: 5px'>" + (_this.controls_html()) + "</div>");
    ...
    Thebe.prototype.kernel_controls_html = function() {
      return "<button class='btn btn-toolbar btn-primary btn-embossed' data-action='run-above'>Run All</button> <button class='btn btn-toolbar btn-primary btn-embossed' data-action='interrupt'>Interrupt</button> <button class='btn btn-toolbar btn-primary btn-embossed' data-action='restart'>Restart</button>";
    };
